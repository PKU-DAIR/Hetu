...
bash scripts/llama_lora_multi_task.sh 7B 16 7 6 16384 $SERVER_ADDR $SERVER_PORT exp_task6 7B_homo_fuse
...
export DP_BUCKET=OFF
bash scripts/llama_lora_multi_task.sh 7B 16 7 1 8192 $SERVER_ADDR $SERVER_PORT exp_task6_0 7B_homo_seq_1
bash scripts/llama_lora_multi_task.sh 7B 16 7 1 16384 $SERVER_ADDR $SERVER_PORT exp_task6_1 7B_homo_seq_2
bash scripts/llama_lora_multi_task.sh 7B 16 7 1 16384 $SERVER_ADDR $SERVER_PORT exp_task6_2 7B_homo_seq_2
bash scripts/llama_lora_multi_task.sh 7B 16 7 1 8192 $SERVER_ADDR $SERVER_PORT exp_task6_3 7B_homo_seq_1
bash scripts/llama_lora_multi_task.sh 7B 16 7 1 16384 $SERVER_ADDR $SERVER_PORT exp_task6_4 7B_homo_seq_2
bash scripts/llama_lora_multi_task.sh 7B 16 7 1 16384 $SERVER_ADDR $SERVER_PORT exp_task6_5 7B_homo_seq_2
echo "====================================================== 7B, 16 GPUs Task-Sequential end ======================================================"
echo "====================================================== 7B, 16 GPUs LobRA begin ======================================================"
export DP_BUCKET=ON
bash scripts/llama_lora_multi_task.sh 7B 16 16 6 $SERVER_ADDR $SERVER_PORT exp_task6 7B_hetero_fuse
...
bash scripts/llama_lora_multi_task.sh 7B 16 16 6 16384 $SERVER_ADDR $SERVER_PORT exp_task6 7B_hetero_fuse
...
do
    ...
    export DP_BUCKET=ON
    export EXPR_DATA_DISPATCH=BALANCE
    bash scripts/llama_lora_multi_task.sh 7B 16 ${bucket_num} 6 16384 $SERVER_ADDR $SERVER_PORT exp_task6 7B_hetero_fuse
